...
output_file = '/media/datassd/sina/perf-characterization/myoutputs/merged_pathpoints_howmanylocalminima_mm3_50_tsbased_lastone_wdup.csv'
...
for file in csv_files:
    ...
    for index, row in df.iterrows():
        dfs.append(row)
        '''
        config_key = tuple(row[8])  # get the tile size as the config (I have to change this row[8] is being deprecated)
